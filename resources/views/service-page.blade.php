...
@section('content')
  @while(have_posts()) @php the_post() @endphp
    ...
    <div class="flex flex-wrap -mt-24 z-0 <?php echo sanitize_title_with_dashes(get_the_title(get_the_ID())); ?>-hero" data-aos="fade" data-aos-duration="1000">
      <div class="w-5/6 lg:w-2/3 pt-48 pb-32 lg:pt-56 lg:pb-32 text-white mx-auto">
        <h6 class="font-oswald text-sm md:text-lg lg:text-xl pb-3 uppercase" data-aos="fade-left" data-aos-duration="1000" data-aos-easing="ease-in-sine">a practice management partner</h6>
