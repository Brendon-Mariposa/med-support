<div id="services" class="flex flex-wrap">
    <div class="w-full bg-gray-200 py-8 text-center">
        ...
        <h2 class="font-oswald text-4xl font-bold uppercase pb-1">
        ...
        <p class="font-open text-2xl font-thin">
        
        <?php if ( is_page( 'Special Projects') ): 
            echo 'Do you need help with one of these tasks? Click which one you need assistance with.'; 
            else: 
            echo 'Need help with something else? Try one of these.'; 
            endif; 
        ?>
    ...
    <a href="/managed-care-insurance-contracting-assistance/" class="relative w-full md:w-1/3 bg-gray-200 text-center py-5 bg-cover bg-center border-0 border-color-85c879 hover:border-4 service-square managed-care-insurance-contracting-assistance-square">
    <div class="py-24"></div>
    ...
    <div class="py-24"></div>
    <h2 class="absolute bottom-0 left-0 font-oswald text-3xl font-bold text-white p-4 text-left">Coding and Chart Review</h2>
    </a>
    <a href="/business-office-assessment/" class="relative w-full md:w-1/3 bg-gray-200 text-center py-5 bg-cover bg-center border-0 border-color-85c879 hover:border-4 service-square business-office-assessment-square">
    <div class="py-24"></div>
